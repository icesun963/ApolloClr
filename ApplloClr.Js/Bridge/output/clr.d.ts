...
declare module ApolloClr {
    ...
    export interface Clr {
        ...
        evaluationStack_Push$1(obj: number): void;
        evaluationStack_Push$2(args: number[]): void;
         ...
         * @return  {void}
         */
        ldc(i: number, v: number): void;
        ldc_R4(v: number): void;
        /**
         ...
         * @return  {void}
         */
        ldlocLdloc(i: number, i2: number): void;
        /**
         * ��ֵ��CallStack�е�i��λ��
         *
         * @instance
         ...
         * @return  {void}
         */
        ldcStloc(li: number, lv: number, si: number): void;
        /**
         * ���ô�
         *
         * @instance
        ...
        nop(): void;
        reset(): void;
        dump(action: {(arg: number): void}): void;
        /**
         * 无条件地将控制转移到目标指令（短格式）。
         *
         * @instance
    ...
    export interface MethodTasks {
        ...
        compile(OnCallAction?: {(arg: ApolloClr.IOpTask): void}): ApolloClr.MethodTasks;
    ...
    export interface MethodTasksFunc extends Function {
        ...
        build<T>(T: {prototype: T}, list: System.Collections.Generic.List$1<ApolloClr.ILCode>, lcount?: number, acount?: number, haseResult?: boolean, maxstack?: number): T;
    ...
    export interface OpCodeTask$2<TV1,TV2> extends ApolloClr.BaseOpTask,ApolloClr.IOpTask {
    ...
    export interface OpCodeTask$1<TV1> extends ApolloClr.BaseOpTask,ApolloClr.IOpTask {
        func: {(arg: TV1): void};
        V1: TV1;
        getBindFunc(): Function;
        run(): void;
    ...
    export interface OpCodeTask extends ApolloClr.BaseOpTask,ApolloClr.IOpTask {
        func: {(): void};
        getBindFunc(): Function;
        run(): void;
    }
    ...
    export interface OpCodeTask$3<TV1,TV2,TV3> extends ApolloClr.BaseOpTask,ApolloClr.IOpTask {
...
declare module ApolloClr.Method {
    ...
    export interface ILCodeParseFunc extends Function {
        ...
        new (): ILCodeParse;
        readILCodes(ilcodes: string): System.Collections.Generic.List$1<ApolloClr.ILCode>;
        readILCodes$1(lines: string[]): System.Collections.Generic.List$1<ApolloClr.ILCode>;
        /**
         * 指令优化，合并指令
         *
         * @static
         ...
         */
        mergeCodes(input: System.Collections.Generic.List$1<ApolloClr.ILCode>): System.Collections.Generic.List$1<ApolloClr.ILCode>;
    }
